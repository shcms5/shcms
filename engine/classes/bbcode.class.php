...
class bbcode {
    ...
    var $info_about_tags = array(
            '*' => array(
                    ...
                    'children' => array('align','b','code','color','email',
                        ...
                        'php','quote','s','size','sub','sup','table','tt','u','url','audio','video')
                ),
            'align' => array(
                    'handler' => 'align_2html',
                    'is_close' => false,
                    ...
                    'children' => array('align','b','code','color','email',
                        ...
                        'nobb','php','quote','s','size','sub','sup','table','tt','u','url','audio','video')
                ),
            'b' => array(
                    'handler' => 'b_2html',
                    'is_close' => false,
                    ...
                    'permission_top_level' => true,
                    'children' => array('b','color','small','email','font','google','i','img',
                        'nobb','s','size','sub','sup','tt','u','url','audio','video')
                ),
			'small' => array(
            'handler' => 'small_2html',
            'is_close' => false,
            ...
            'caption' => array(
                    ...
                    'ends' => array('tr'),
                    'permission_top_level' => false,
                    'children' => array('b','color','small','email','font','google','i','nobb',
                        's','size','sub','sup','tt','u','url','audio','video')
                ),
            'code' => array(
                    'handler' => 'code_2html',
                    'is_close' => false,
            ...
            'email' => array(
                    ...
                    'ends' => array('*','align','code','h1','h2','h3','hr',
                        'list','php','quote','table','td','th','tr'),
                    'permission_top_level' => true,
                    'children' => array('b','color','small','email','font','i','img',
            ...
            'font' => array(
                    ...
                    'ends' => array('*','align','code','h1','h2','h3','hr',
                        'list','php','quote','table','td','th','tr'),
                    'permission_top_level' => true,
                    'children' => array('b','color','small','email','font','font','google','i',
                        'img','nobb','s','size','sub','sup','tt','u','url','audio','video')
                ),
            'google' => array(
                    ...
                    'ends' => array('*','align','code','h1','h2','h3','hr',
                        'list','php','quote','table','td','th','tr'),
                    'permission_top_level' => true,
                    'children' => array('b','color','small','font','i','img','nobb',
                        's','size','sub','sup','tt','u')
                ),
            'h1' => array(
                    'handler' => 'h1_2html',
            ...
            'tt' => array(
                    ...
                    'ends' => array('*','align','code','h1','h2','h3','hr',
                        'list','php','quote','table','td','th','tr'),
                    'permission_top_level' => true,
                    'children' => array('b','color','small','email','google','i','img','nobb',
                        's','size','sub','sup','tt','u','url','audio','video')
                ),
            'u' => array(
                    'handler' => 'u_2html',
            ...
            'url' => array(
                    ...
                    'permission_top_level' => true,
                    'children' => array('b','color','small','font','i','img','nobb',
                        's','size','sub','sup','tt','u','audio','video')
                ),
            'audio' => array(
                    'handler' => 'audio_2html',
                    'is_close' => false,
    ...
    */
    ...
    function audio_2html($elem) {
	    $upp = '/modules/download/player/uppod.swf';
		$param = 'width="500" height="41"';
		$taudio = '/modules/download/player/audio/audio127-611.txt';
		
        $audio = files::player($upp,$param,$taudio,urlencode($elem['val'][0]['str']));
    ...
    function video_2html($elem) {
	    $upp = '/modules/download/player/uppod.swf';
		$param = 'width="500" height="321"';
		$tvideo = '/modules/download/player/video/video127-1278.txt';
		
        $video = files::player($upp,$param,$tvideo,urlencode($elem['val'][0]['str']));
    ...
    function quote_2html($elem) {
        ...
        $author = $author
            ? '<h4>'.$author.' писал(а):</h4>'
            : '';
        return '<div class="bs-callout bs-callout-primary">'
            .$author.''.$this -> get_html($elem['val'])
            .'</div>';
    }
